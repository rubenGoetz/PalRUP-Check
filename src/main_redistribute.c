...
int main(int argc, char *argv[]) {
    const char *formula_path = "", *working_path = "";
    ...
    snprintf(palrup_utils_msgstr, 512, "Option list: -formula-path=%s -working-path=%s -num-solvers=%lu -pal-id=%lu -redist-strat=%lu",
             formula_path, working_path, num_solvers, pal_id, redist_strat);
